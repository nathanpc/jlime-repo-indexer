...
--
-- Host: localhost    Database: jlime_repos
-- ------------------------------------------------------
...
INSERT INTO `repos` VALUES (1,'mongo','base|charmap|dev|doc|jornada7xx|lib|locale|morgue|x11'),(2,'shrek',''),(3,'donkey','a|b|c|d|e|f|g|h|i|j|k|l|m|n|o|p|q|r|s|t|u|v|w|x|y|z'),(4,'vargtass','a|b|c|d|e|f|g|h|i|j|k|l|m|n|o|p|q|r|s|t|u|v|w|x|y|z');
...
-- Dump completed on 2013-01-27 18:37:37
